...
; Fuchsia Gym
	db 33,ODDISH,HAUNTER,VENONAT,KOFFING,0	;db 31,DROWZEE,DROWZEE,KADABRA,DROWZEE,0
...
BrockData:
	db $FF,12,GEODUDE,15,ONIX,10,CHANSEY,0
MistyData:
	db $FF,15,ODDISH,18,STARYU,22,STARMIE,0
LtSurgeData:
	db $FF,18,PIKACHU,21,VOLTORB,25,RAICHU,0
ErikaData:	;LGPE
	db $FF,33,TANGELA,33,VICTREEBEL,34,VILEPLUME,0
KogaData:
	db $FF,37,KOFFING,39,MUK,37,KOFFING,43,WEEZING,0
BlaineData:
	db $FF,42,FLAREON,40,CHARIZARD,48,NINETALES,47,MAGMAR,50,RAPIDASH,48,ARCANINE,0
SabrinaData:
