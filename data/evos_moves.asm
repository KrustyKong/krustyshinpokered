...
; Learnset
	db 18, DISABLE
	db 22, BODY_SLAM	;wasHeadbutt
	db 27, PSYBEAM	;wasGrowl
	db 33, SURF		;wasWater Gun
	db 37, WITHDRAW
	db 44, AMNESIA
	db 55, PSYCHIC_M
	db 0
...
IvysaurEvosMoves:
; Evolutions
	db EV_ITEM, LEAF_STONE, 1, VENUSAUR
	db 0
; Learnset
	db 7, LEECH_SEED
	db 13, VINE_WHIP
...
; Evolutions
	db 0
; Learnset	joenote-modified for yellow
	db 27, MEGA_DRAIN	;wasAbsorb
	db 29, VINE_WHIP
	db 32, POISONPOWDER
	db 36, STUN_SPORE
	db 39, SLEEP_POWDER
	db 45, AMNESIA		;gen2 eggmove. was mega drain
	db 49, GROWTH
	db 0
...
; Evolutions
	...
	db 0
; Learnset	gen3 levels
	db 13, KARATE_CHOP
	db 19, SEISMIC_TOSS
	db 22, MEDITATE
	db 25, COUNTER	;GENIV eggmove
	db 31, SUBMISSION
	db 0
